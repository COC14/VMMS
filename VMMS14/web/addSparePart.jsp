                                ...
                                <div class="rb_form">
                                    <form name="results" method="post" action="AddSparePart.jsp">.
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control " id="sp_name" type="text" name="sp_name" placeholder="Spare Part Name" required data-validation-required-message="Please enter your name" />
                                            </div>

                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                                <input class="form-control " id="cost" type="text" name="cost" placeholder="Cost" required data-validation-required-message="Fill in this field" />
                                            </div>

                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-envelope-o"></i></span>
                                                <input class="form-control " id="quantity" type="text" name="quantity" placeholder="Quantity" required data-validation-required-message="Fill in this field" />
                                            </div>
